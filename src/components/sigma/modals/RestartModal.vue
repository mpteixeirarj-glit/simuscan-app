  ...
  <div class="sigma-modal-backdrop" @click.self="$emit('close')">
    <div class="sigma-modal">
      ...
      <div class="modal-body">
        ...
        <p class="confirm-text">Deseja reiniciar o sistema Sigma Healthcare?</p>
        <p class="confirm-sub">Todos os processos em andamento serão encerrados. O sistema estará disponível novamente em aproximadamente 2 minutos.</p>
        <div class="confirm-actions">
          <button class="ca-btn ca-btn--primary" @click="handleRestart">Reiniciar</button>
...
function handleRestart() {
  emit('close')
  // In a real system this would trigger a restart sequence
  // For simulation, just close the modal
}
</script>
...
.confirm-icon { font-size: 2.4rem; color: #3498db; }
...
.ca-btn--primary { background: #3498db; border-color: #3498db; color: #fff; }
.ca-btn--primary:hover { opacity: 0.88; border-color: #3498db; }
</style>
